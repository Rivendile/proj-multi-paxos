...
class Acceptor (MessageHandler):
    ...
    def receive_prepare(self, msg):
        ...
        '''
        if self.promised_id==None or msg.proposal_id >= self.promised_id:
...
class Learner (MessageHandler):
    ...
    def receive_accepted(self, msg):
        ...
        if self.final_value is not None:
            if (self.final_proposal_id==None or msg.proposal_id >= self.final_proposal_id) and msg.proposal_value == self.final_value:
